...
class ClausBackgroundCanvas(tk.Canvas):
    def __init__(
        ...
        self.avg_color = self.average_color(self._background)
        self.contrast_color = self.contrast_color_from_avg(self.avg_color)
    ...
    def average_color(self, img: Image.Image):
    ...
    def contrast_color_from_avg(self, hex_color: str):
