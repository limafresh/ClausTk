...
from .widgets.claus_menu import ClausMenu as ClausMenu
...
from .widgets.claus_toplevel import ClausToplevel as ClausToplevel
from .widgets.claus_window import ClausWindow as ClausWindow
